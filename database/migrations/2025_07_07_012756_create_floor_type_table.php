...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('floor_type', function (Blueprint $table) {
            ...
            $table->boolean('display_flg')->default(false)->comment('表示フラグ');
            ...
            $table->json('additional_data')->nullable()->comment('専有面積以外の名前、㎡、坪');
            ...
            $table->index('building_id', 'idx_floor_type_building_id');
        });

        Schema::create('floor_type_history', function (Blueprint $table) {
            $table->bigIncrements('id')->comment('ID');
            $table->unsignedBigInteger('floor_type_id')->comment('floor_typeのID');
